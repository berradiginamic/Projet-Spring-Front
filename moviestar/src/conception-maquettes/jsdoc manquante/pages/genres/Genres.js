...
/**
 * Composant pour afficher et gérer les genres des films et séries TV populaires.
 * @component
...
const Genres = () => {
    ...
    /**
     * Récupère les films associés au genre sélectionné.
    ...
    /**
     * Affiche les films du genre sélectionné.
    ...
    /**
     * Supprime un genre.
     * @param {number} genreId - ID du genre à supprimer.
     */
        ...
        <div>
            ...
            {isModalOpen && (
                <div className="modal">
                    ...
                    {selectedGenreFilms.length > 0 && renderSelectedGenreFilms()}
                </div>
            )}
